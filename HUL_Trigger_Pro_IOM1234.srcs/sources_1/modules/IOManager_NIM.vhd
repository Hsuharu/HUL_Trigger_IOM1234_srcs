...
--    Else_OR                    : in  std_logic; 
--    BH2_K                      : in  std_logic_vector( 7 downto 0 );
--    Beam                       : in  std_logic; 
--    Pi_Beam                    : in  std_logic; 
--    P_Beam                     : in  std_logic; 
----    BH2_Pi                     : in  std_logic; 
--    BH2_Pi_PS                  : in  std_logic;
--    BH1_or                     : in  std_logic;
--    BH2_or                     : in  std_logic;
--    SAC_or                     : in  std_logic;
--    TOF_or                     : in  std_logic;
...
--    Beam_P                     : in  std_logic; 
--    Beam_TOF_PS                : in  std_logic; 
--    Beam_Pi_PS                 : in  std_logic; 
--    Beam_P_PS                  : in  std_logic; 
--    Coin1                      : in  std_logic; 
--    Coin2                      : in  std_logic; 
--    Coin1_PS                   : in  std_logic; 
--    Coin2_PS                   : in  std_logic; 
--    For_E03                    : in  std_logic;
--    For_E03_PS                 : in  std_logic;
--    Clock_sel                  : in  std_logic;
--    Reserve2_sel               : in  std_logic;
--        : in  std_logic;
--        : in  std_logic;
--        : in  std_logic;
--        : in  std_logic;
...
begin
  ...
  nimout1    <= BH1_Beam                    when(reg_nimout1 = "000000") else
                ...
                BH2_DLY(7)                  when(reg_nimout1 = "101001") else '0';
  ...
  nimout2    <= BH1_Beam                    when(reg_nimout2 = "000000") else
                ...
                BH2_DLY(7)                  when(reg_nimout2 = "101001") else '0';
  ...
  nimout3    <= BH1_Beam                    when(reg_nimout3 = "000000") else
                ...
                BH2_DLY(7)                  when(reg_nimout3 = "101001") else '0';
  ...
  nimout4    <= BH1_Beam                    when(reg_nimout4 = "000000") else
                ...
                BH2_DLY(7)                  when(reg_nimout4 = "101001") else '0';


--  nimout3    <= Else_OR                     when(reg_nimout3 = "000000") else
--                BH2_K(0)                    when(reg_nimout3 = "000001") else
--                BH2_K(1)                    when(reg_nimout3 = "000010") else
--                BH2_K(2)                    when(reg_nimout3 = "000011") else
--                BH2_K(3)                    when(reg_nimout3 = "000100") else
--                BH2_K(4)                    when(reg_nimout3 = "000101") else
--                BH2_K(5)                    when(reg_nimout3 = "000110") else
--                BH2_K(6)                    when(reg_nimout3 = "000111") else
--                BH2_K(7)                    when(reg_nimout3 = "001000") else
--                Other1                      when(reg_nimout3 = "001001") else
--                Other2                      when(reg_nimout3 = "001010") else
--                Other3                      when(reg_nimout3 = "001011") else
--                Other4                      when(reg_nimout3 = "001100") else
--                Other5                      when(reg_nimout3 = "001101") else
--                Clock_sel                   when(reg_nimout3 = "001110") else
--                Reserve2_sel                when(reg_nimout3 = "001111") else
--                BH1_or                      when(reg_nimout3 = "010000") else
--                BH2_or                      when(reg_nimout3 = "010001") else
--                SAC_or                      when(reg_nimout3 = "010010") else
--                TOF_or                      when(reg_nimout3 = "010011") else
--                Lucite_or                   when(reg_nimout3 = "010100") else
--                TOF_High_Threshold          when(reg_nimout3 = "010101") else
--                Beam                        when(reg_nimout3 = "010110") else
--                Pi_Beam                     when(reg_nimout3 = "010111") else
--                P_Beam                      when(reg_nimout3 = "011000") else
--                K_Scat                      when(reg_nimout3 = "011001") else
--                Beam_TOF                    when(reg_nimout3 = "011010") else
--                Beam_Pi                     when(reg_nimout3 = "011011") else
--                Beam_P                      when(reg_nimout3 = "011100") else
--                Coin1                       when(reg_nimout3 = "011101") else
--                Coin2                       when(reg_nimout3 = "011110") else
--                For_E03                     when(reg_nimout3 = "011111") else
--                BH2_Pi_PS                   when(reg_nimout3 = "100000") else
--                Beam_TOF_PS                 when(reg_nimout3 = "100001") else 
--                Beam_Pi_PS                  when(reg_nimout3 = "100010") else  
--                Beam_P_PS                   when(reg_nimout3 = "100011") else  
--                Coin1_PS                    when(reg_nimout3 = "100100") else  
--                Coin2_PS                    when(reg_nimout3 = "100101") else  
--                For_E03_PS                  when(reg_nimout3 = "100110") else '0' ;
--
--  nimout4    <= Else_OR                     when(reg_nimout4 = "000000") else
--                BH2_K(0)                    when(reg_nimout4 = "000001") else
--                BH2_K(1)                    when(reg_nimout4 = "000010") else
--                BH2_K(2)                    when(reg_nimout4 = "000011") else
--                BH2_K(3)                    when(reg_nimout4 = "000100") else
--                BH2_K(4)                    when(reg_nimout4 = "000101") else
--                BH2_K(5)                    when(reg_nimout4 = "000110") else
--                BH2_K(6)                    when(reg_nimout4 = "000111") else
--                BH2_K(7)                    when(reg_nimout4 = "001000") else
--                Other1                      when(reg_nimout4 = "001001") else
--                Other2                      when(reg_nimout4 = "001010") else
--                Other3                      when(reg_nimout4 = "001011") else
--                Other4                      when(reg_nimout4 = "001100") else
--                Other5                      when(reg_nimout4 = "001101") else
--                Clock_sel                   when(reg_nimout4 = "001110") else
--                Reserve2_sel                when(reg_nimout4 = "001111") else
--                BH1_or                      when(reg_nimout4 = "010000") else
--                BH2_or                      when(reg_nimout4 = "010001") else
--                SAC_or                      when(reg_nimout4 = "010010") else
--                TOF_or                      when(reg_nimout4 = "010011") else
--                Lucite_or                   when(reg_nimout4 = "010100") else
--                TOF_High_Threshold          when(reg_nimout4 = "010101") else
--                Beam                        when(reg_nimout4 = "010110") else
--                Pi_Beam                     when(reg_nimout4 = "010111") else
--                P_Beam                      when(reg_nimout4 = "011000") else
--                K_Scat                      when(reg_nimout4 = "011001") else
--                Beam_TOF                    when(reg_nimout4 = "011010") else
--                Beam_Pi                     when(reg_nimout4 = "011011") else
--                Beam_P                      when(reg_nimout4 = "011100") else
--                Coin1                       when(reg_nimout4 = "011101") else
--                Coin2                       when(reg_nimout4 = "011110") else
--                For_E03                     when(reg_nimout4 = "011111") else
--                BH2_Pi_PS                   when(reg_nimout4 = "100000") else
--                Beam_TOF_PS                 when(reg_nimout4 = "100001") else 
--                Beam_Pi_PS                  when(reg_nimout4 = "100010") else  
--                Beam_P_PS                   when(reg_nimout4 = "100011") else  
--                Coin1_PS                    when(reg_nimout4 = "100100") else  
--                Coin2_PS                    when(reg_nimout4 = "100101") else  
--                For_E03_PS                  when(reg_nimout4 = "100110") else '0' ;
